...
{
    public class PayDatesService
    {
        private readonly int[] _monthsWith30Days;
        private readonly int[] _monthsWith31Days;
        private readonly IAdjustDatesService _adjustDatesService;

        public PayDatesService(IAdjustDatesService adjustDatesService)
        {
            _monthsWith30Days = new [] { 4, 6, 9, 11};
            _monthsWith31Days = new [] { 1, 3, 5, 7, 8, 10, 12 };
            _adjustDatesService = adjustDatesService;
        }
